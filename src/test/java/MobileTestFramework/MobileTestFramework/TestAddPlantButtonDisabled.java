...
public class TestAddPlantButtonDisabled extends BaseClass{
	...
	@Test( enabled=true )
	public void testAddButtonDisabled() throws IOException {
		...
		try {
			  ...
			  System.out.println("Add Button is not present on the selected product screen.");
			}
